...
| **F3b** | Administrace – obsah | **Zobrazovací sady (hotovo)**, editace kurzu (obohacený obsah, kontakt na lektora, příznak přihlášek, zámky polí), **ruční kurzy** zakládané ručně i jedním kliknutím z nespárovaného termínu, obrazovka nespárovaných lekcí, **obrazovka náhradních lekcí (hotovo)**, **editace kurzu se zámky polí a kontaktem na lektora (hotovo)**, **obrazovka nespárovaných lekcí (hotovo)**, **hromadné nastavení tlačítka (hotovo)**, mapování sálů, hromadné akce | 1,5 dne |
