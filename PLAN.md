...
| **F7** | Detail kurzu + frontend | ✅ *z větší části hotovo* – stránka detailu kurzu (obsah, fakta, kontakt na lektora, tlačítko, rozvrh kurzu, náhradní lekce u kurzu), šablona přepsatelná v tématu, JSON-LD `Course`. **Zbývá:** filtrování a stránkování bez reloadu a přepínač týdnů | 2 dny |
