...
?>
<div class="cscs cscs--schedule" id="cscs-<?php echo esc_attr( $listing->set->id ); ?>" data-cscs-set="<?php echo esc_attr( $listing->set->id ); ?>" data-cscs-page="<?php echo esc_attr( (string) $listing->args->page ); ?>" data-cscs-week="<?php echo esc_attr( (string) $listing->args->week ); ?>" data-cscs-room="<?php echo esc_attr( (string) $listing->args->room ); ?>">
